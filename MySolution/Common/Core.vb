...
#End Region
    ...
    Public Shared Function GenerateURL(Title As Object, strId As Object, strModule As Object) As String
        ...
        strTitle = (Convert.ToString(strModule) & strTitle) & "-" & strId '& ".aspx"
