<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/FrontEnd/Home.Master" CodeBehind="News4.aspx.vb" Inherits="HoaQuaVn.News4" %>
<%@ Register Src="~/FrontEnd/UserControl/News/ucNews.ascx" TagPrefix="uc1" TagName="ucNews" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div class="news-title">Cách chọn trái cây ngon</div>
      <div id="powered"></div>
    <div class="news-image">
        <img src="FrontEnd/image/news/04.jpg"></div>
    <div class="news-body">
